...
class Fase2 extends Phaser.Scene {
	...
	create(){//cria os elementos e variáveis base
		...
		this.bg = this.add.image(0,0,"bgfase2");
		this.bg.setOrigin(0,0);

		this.campo = this.add.image(412, 302, "campo2");
		...
		this.zero = this.add.image(1015,301,"zero");
		this.zero.setScale(0.75);
		
		estrela = this.add.image(1021, 189, "estrela");//estrela de qunado o inimigo leva dano
		...
		this.zeroAfrente = this.add.image(1015,301,"zero");
		this.zeroAfrente.setScale(0.75);
	...
	atualizaDica(){//dá dicas dependendo da interação com o botão dicas(como jogar/ exemplo de operação e resultado/ como realizar a jogada)
		switch (DicaAtual) {
		    ...
		    case 3:
		    	...
		    	this.textoDica.text = "Com o poder das operações, eu fico mais \nforte e não perco para ninguém."
		    	break;
		    case 4:
		    	this.zeroAfrente.visible = false;
		    	this.n4.visible = true;
		    	this.textoDica.text = "Agora nós podemos usar a subtração \ncontra ele, vamos lá."
		    	break;
		    case 5:
		    	this.n4.visible =false;
				this.textoDica.text = "O que é para fazer?";
			...
			case 6:
				this.zeroAfrente.visible = true;
		    	this.textoDica.text = "Isso ainda não acabou herói, vamos \nnos encontar mais uma vez."
		    	break;
		    case 7:
		    	this.zeroAfrente.visible = false;
		    	this.n4.visible = true;
		    	this.textoDica.text = "Ele deve estar querendo aprontar mais \nalguma coisa, vamos ficar de olho nele."
		    	break;
		    case 8:
		    	this.n4.visible =false;
				this.textoDica.text = "O que é para fazer?";
